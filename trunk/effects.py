...
# every 5 frames. see waketimer.
        if self.wakeTimer == 0:
            self.wake.append(StaticBlockParticle(self.view, 1.5, self.xy[0] + random.random()*self.maxSize - (self.maxSize / 2), self.xy[1] + random.random()*self.maxSize - (self.maxSize / 2), 50, (150, 150, 150)))
